...
$app->post('/api/departamentos/add', function(Request $request, Response $response){
    ...
    $sql = "INSERT INTO departamento (ClaveDepa, nombre_depa, trabajador_rfc_trabajador) VALUES (:ClaveDepa, :nombre_depa, :trabajador_rfc)";
...
$app->put("/api/departamentos/update/{ClaveDepa}", function(Request $request, Response $response){
    ...
    $sql = "UPDATE departamento SET
				...
				trabajador_rfc_trabajador = :trabajador_rfc
...
$app->get('/api/instructores/{clave_inst}', function(Request $request, Response $response){
    $clave_inst = $request->getAttribute('clave_inst');

    $sql = "SELECT * FROM instructor WHERE rfc_instructor = '".$clave_inst."'";
...
$app->post('/api/instructores/add', function(Request $request, Response $response){
    ...
    $apellido_paterno_instructor = $request->getParam('apellido_paterno_instructor');
    $apellido_materno_instructor = $request->getParam('apellido_materno_instructor');
    $act_complementaria_clave_act = $request->getParam('act_complementaria_clave_act');

    $sql = "INSERT INTO instructor (rfc_instructor, nombre_instructor, apellido_paterno_instructor, apellido_materno_instructor, act_complementaria_clave_act) VALUES (:rfc_instructor, :nombre_instructor,:apellido_paterno_instructor,:apellido_materno_instructor,:act_complementaria_clave_act)";
    ...
    try{
        ...
        $stmt->bindParam(':apellido_paterno_instructor',$apellido_paterno_instructor);
        $stmt->bindParam(':apellido_materno_instructor',$apellido_materno_instructor);
        $stmt->bindParam(':act_complementaria_clave_act',$act_complementaria_clave_act);


        $stmt->execute();

        echo '{"notice": {"text": "instructor agregada"}';
...
$app->put('/api/instructores/update/{rfc_instructor}', function(Request $request, Response $response){
    ...
    $sql = "UPDATE instructor SET
                ...
                apellido_paterno_instructor = :apellido_paterno_instructor,
                apellido_materno_instructor = :apellido_materno_instructor,
...
$app->delete('/api/instructores/delete/{rfc_instructor}', function(Request $request, Response $response){
    ...
    try{
        ...
        $stmt->execute();
        $db = null;
        echo '{"notice": {"text": "Instructor eliminada"}';
    } catch(PDOException $e){
        echo '{"error": {"text": '.$e->getMessage().'}';
    }
});
